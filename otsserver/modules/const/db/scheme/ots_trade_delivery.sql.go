...
const ots_trade_delivery=`
	...
	CREATE TABLE IF NOT EXISTS ots_trade_delivery (
		...
		invoice_type int  not null  comment '支持开票（1.不支持）' ,
		...
		real_discount decimal(20,5)    comment '实际折扣' ,
		...
		trade_fee_amount decimal(20,5) default 0 not null  comment '发货服务费' ,
		payment_fee_amount decimal(20,5) default 0 not null  comment '支付服务费' ,
