...
| 字段名      | 类型         | 默认值  | 为空  |    约束     | 描述     |
| :---------- | :----------- | :-----: | :---: | :---------: | :------- |
| spp_no      | varchar2(32) |         |  否   |  PK,l,r,DI  | 编号     |
| spp_name    | varchar2(64) |         |  否   |  q,l,r,DN   | 名称     |
| mer_crop    | varchar2(64) |         |  是   |     l,r     | 公司     |
| bd_uid      | number(20)   |    0    |  是   |      r      | 商务人员 |
| status      | number(1)    |    0    |  是   | q,l,r,sl,cc | 状态     |
...
| 字段名               | 类型          | 默认值  | 为空  |            约束             | 描述                 |
| -------------------- | ------------- | :-----: | :---: | :-------------------------: | :------------------- |
| spp_shelf_id         | number(10)    |   600   |  否   |        PK,SEQ,l,r,DI        | 货架编号             |
| spp_shelf_name       | varchar2(64)  |         |  否   |          q,l,r,DN           | 货架名称             |
| spp_no               | varchar2(32)  |         |  否   | l,r,q,sl(ots_supplier_info) | 供货商               |
| req_url              | varchar2(128) |         |  否   |              r              | 请求地址             |
| query_url            | varchar2(128) |         |  是   |              r              | 查询地址             |
| notify_url           | varchar2(128) |         |  是   |              r              | 回调地址             |
| invoice_type         | number(2)     |    1    |  是   |       l,r,sl(bool),cc       | 开发票               |
| spp_fee_discount     | number(10,5)  |    0    |  是   |             l,r             | 商户佣金             |
| trade_fee_discount   | number(10,5)  |    0    |  是   |             l,r             | 交易服务费           |
| payment_fee_discount | number(10,5)  |    0    |  是   |             l,r             | 支付手续费           |
| can_refund           | number(1)     |    1    |  是   |       l,r,sl(bool),cc       | 支持退货 (0.是,1.否) |
| status               | number(1)     |    0    |  是   |         q,l,r,sl,cc         | 货架状态             |
| limit_count          | number(10)    |    1    |  是   |              r              | 单次最大发货数量     |
| create_time          | date          | sysdate |  是   |             l,r             | 创建时间             |
...
| spp_shelf_id   | number(10)   |         |  否   | l,r,q,sl(ots_supplier_shelf) | 货架           |
| spp_no         | varchar2(32) |         |  否   | l,r,q,sl(ots_supplier_info)  | 供货商         |
| spp_product_no | varchar2(32) |         |  是   |              r               | 供货商商品编号 |
| pl_id          | number(10)   |         |  否   |  l,r,q,sl(ots_product_line)  | 产品线         |
| brand_no       | varchar2(8)  |         |  否   |       l,q,r,sl(brand)        | 品牌           |
| province_no    | varchar2(8)  |    *    |  是   |      l,r,q,sl(province)      | 省份           |
| city_no        | varchar2(8)  |    *    |  是   |         l,r,sl(city)         | 城市           |
| face           | number(10)   |         |  否   |             l,r              | 面值           |
| cost_discount  | number(10,5) |         |  否   |             l,r              | 成本折扣       |
| status         | number(1)    |    0    |  否   |          l,r,sl,cc           | 状态           |
| create_time    | date         | sysdate |  是   |             l,r              | 创建时间       |
...
| 字段名      | 类型         | 默认值  | 为空  |                        约束                         | 描述       |
| ----------- | ------------ | :-----: | :---: | :-------------------------------------------------: | :--------- |
| id          | number(20)   |   100   |  否   |                     PK,SEQ,l,r                      | 编号       |
| spp_no      | varchar2(32) |         |  否   | q,l,r,UNQ(unq_spp_error_code),sl(ots_supplier_info) | 商家       |
| pl_id       | number(10)   |         |  否   | q,l,r,UNQ(unq_spp_error_code),sl(ots_product_line)  | 产品线     |
| category    | varchar2(32) |         |  否   | q,l,r,UNQ(unq_spp_error_code),sl(result_source),cc  | 分类       |
| deal_code   | number(1)    |         |  否   |                         l,r                         | 处理码     |
| error_code  | varchar2(32) |         |  否   |             l,r,UNQ(unq_spp_error_code)             | 错误码     |
| status      | number(1)    |    0    |  否   |                    l,r,s,q,cc,sl                    | 状态       |
| error_desc  | varchar2(64) |         |  否   |                         l,r                         | 错误码描述 |
| create_time | date         | sysdate |  否   |                         l,r                         | 创建时间   |
...
| mer_product_id          | number(10)   |    300     |  否   |             r,l             | 商品编号                         |
...
| province_no          | varchar2(8)    |         |  否   |             r,l              | 省份                                          |
| city_no              | varchar2(8)    |         |  否   |              r               | 城市                                          |
| invoice_type         | number(3)      |         |  否   |             r,cc             | 开票方式（1.不开发票）                        |
| account_name         | varchar2(64)   |         |  否   |             r,l              | 用户账户                                      |
| delivery_status      | number(3)      |   20    |  否   |  r,l,sl(process_status),cc   | 发货状态                                      |
...
| result_source        | varchar2(32)   |         |  是   |           r,sl,cc            | 发货结果来源（1：通知，2：查询，3：同步返回） |
