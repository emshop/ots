...
import (
	...
	"github.com/emshop/ots/mgrserver/api/services/life"
...
func init() {
	hydra.OnReady(func() {
		...
		hydra.S.Web("/merchant/upstream", merchant.NewMerchantUpstreamHandler())
		hydra.S.Web("/trade/delivery", trade.NewTradeDeliveryHandler())
		hydra.S.Web("/system/task", system.NewSystemTaskHandler())
		hydra.S.Web("/life/time", life.NewLifeTimeHandler())
		...
		hydra.S.Web("/merchant/package", merchant.NewMerchantPackageHandler())
	})
}
