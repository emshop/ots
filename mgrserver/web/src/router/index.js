  ...
  routes: [
    {
      ...
      children:[
				...
				{
					path: 'merchant/upstream',
					name: 'MerchantUpstream',
					component: () => import('../pages/merchant/merchant.upstream.list.vue')
				},
				{
					path: 'merchant/upstream/detail',
					name: 'MerchantUpstreamDetail',
					component: () => import('../pages/merchant/merchant.upstream.detail.vue')
				},
				{
					path: 'refund/apply',
					name: 'RefundApply',
				...
				},
				{
					...
					component: () => import('../pages/merchant/merchant.package.list.vue')
				},
				{
					path: 'merchant/package/detail',
					name: 'MerchantPackageDetail',
					component: () => import('../pages/merchant/merchant.package.detail.vue')
				},
				{
					path: 'notify/info',
					name: 'NotifyInfo',
				...
				},
				{
					...
					name: 'ProductPackage',
					component: () => import('../pages/product/product.package.list.vue')
				},
				{
					path: 'product/package/detail',
					name: 'ProductPackageDetail',
					component: () => import('../pages/product/product.package.detail.vue')
				},
				{
					path: 'supplier/ecode',
					name: 'SupplierEcode',
