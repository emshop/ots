            ...
            <table :date="info" class="table table-striped m-b-none">
              <tbody class="table-border">
                ...
                <tr>
                  <td>                 
                    <el-col :span="6">
                      <div class="pull-right" style="margin-right: 10px">联系电话:</div>
                    </el-col>
                    <el-col :span="6">
                      <el-tooltip class="item" v-if="info.tel && info.tel.length > 50" effect="dark" placement="top">
                        <div slot="content" style="width: 110px">{{info.tel}}</div>
                        <div >{{ info.tel | fltrSubstr(50) }}</div>
                      </el-tooltip>
                      <div v-else>{{ info.tel | fltrEmpty }}</div>
                    </el-col>                 
                    <el-col :span="6">
                      <div class="pull-right" style="margin-right: 10px">收货地址:</div>
                    </el-col>
                    <el-col :span="6">
                      <el-tooltip class="item" v-if="info.addr && info.addr.length > 50" effect="dark" placement="top">
                        <div slot="content" style="width: 110px">{{info.addr}}</div>
                        <div >{{ info.addr | fltrSubstr(50) }}</div>
                      </el-tooltip>
                      <div v-else>{{ info.addr | fltrEmpty }}</div>
                    </el-col>
                  </td>
                </tr>
                <tr>
