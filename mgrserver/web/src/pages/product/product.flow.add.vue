    ...
    <el-form :model="addData" :inline="true" :rules="rules" ref="addForm" label-width="110px">
      ...
      <el-form-item label="tag标签" prop="tag_name">
			...
			<el-form-item label="成功流程:" prop="success_flow_id">
				<el-select  placeholder="---请选择---" clearable filterable v-model="successFlowIDArray" multiple style="width: 100%;">
			...
			<el-form-item label="失败流程:" prop="failed_flow_id">
				<el-select  placeholder="---请选择---" clearable filterable v-model="failedFlowIDArray" multiple style="width: 100%;">
			...
			<el-form-item label="未知流程:" prop="unknown_flow_id">
				<el-select  placeholder="---请选择---" clearable filterable v-model="unknownFlowIDArray" multiple style="width: 100%;">
