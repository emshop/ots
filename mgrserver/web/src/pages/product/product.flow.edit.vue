<template>
	<el-dialog title="编辑业务流程" width="65%" @closed="closed" :visible.sync="dialogFormVisible">
      ...
      <el-form-item label="流程名称" prop="flow_name">
				<el-input maxlength="64" clearable v-model="editData.flow_name" placeholder="请输入流程名称">
				</el-input>
      </el-form-item>
      
      <el-form-item label="tag标签" prop="tag_name">
				<el-input maxlength="64" clearable v-model="editData.tag_name" placeholder="请输入tag标签">
				</el-input>
      </el-form-item>
			...
			<el-form-item label="成功流程:" prop="success_flow_id">
				<el-select  placeholder="---请选择---" clearable v-model="editData.success_flow_id" style="width: 100%;">
			...
			<el-form-item label="失败流程:" prop="failed_flow_id">
				<el-select  placeholder="---请选择---" clearable v-model="editData.failed_flow_id" style="width: 100%;">
			...
			<el-form-item label="未知流程:" prop="unknown_flow_id">
				<el-select  placeholder="---请选择---" clearable v-model="editData.unknown_flow_id" style="width: 100%;">
      ...
      <el-form-item label="队列名称" prop="queue_name">
				<el-input maxlength="64" clearable v-model="editData.queue_name" placeholder="请输入队列名称">
				</el-input>
      </el-form-item>
      
      <el-form-item label="超时时长" prop="scan_interval">
				<el-input maxlength="10" clearable v-model="editData.scan_interval" placeholder="请输入超时时长">
				</el-input>
      </el-form-item>
      
      <el-form-item label="延后处理时长" prop="delay">
				<el-input maxlength="10" clearable v-model="editData.delay" placeholder="请输入延后处理时长">
				</el-input>
      </el-form-item>
      
      <el-form-item label="超时时长" prop="timeout">
				<el-input maxlength="10" clearable v-model="editData.timeout" placeholder="请输入超时时长">
				</el-input>
      </el-form-item>
      
      <el-form-item label="最大执行次数" prop="max_count">
				<el-input maxlength="10" clearable v-model="editData.max_count" placeholder="请输入最大执行次数">
				</el-input>
      </el-form-item>
