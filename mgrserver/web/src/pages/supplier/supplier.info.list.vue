    ...
    <!-- query start -->
		<div class="panel-body" id="panel-body">
			<el-form ref="form" :inline="true" class="form-inline pull-left">
				<el-form-item>
					<el-input clearable size="medium" v-model="queryData.spp_name" placeholder="请输入供货商名称">
					</el-input>
				</el-form-item>
		...
		<el-scrollbar style="height:100%">
			<el-table :data="dataList.items" stripe style="width: 100%" :height="maxHeight">
				...
				<template slot-scope="scope">
					<span>{{scope.row.spp_no | fltrEmpty }}</span>
				</template>
				...
				<el-table-column   prop="spp_name" label="供货商名称" align="center">
					<template slot-scope="scope">
						...
						<span v-else>{{scope.row.spp_name | fltrEmpty }}</span>
					</template>
				</el-table-column>
