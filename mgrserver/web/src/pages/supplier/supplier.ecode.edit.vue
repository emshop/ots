	...
	<el-dialog title="编辑供货商错误码" width="65%" @closed="closed" :visible.sync="dialogFormVisible">
      ...
      <el-form-item label="编号:" prop="id">
			...
			<el-form-item label="供货商:" prop="spp_no">
				<el-select size="medium" style="width: 100%;"	v-model="editData.spp_no" clearable filterable class="input-cos" placeholder="---请选择---"	>
			...
			<el-form-item label="处理码:" prop="deal_code">
				<el-select size="medium" style="width: 100%;"	v-model="editData.deal_code" clearable filterable class="input-cos" placeholder="---请选择---"	>
...
export default {
	...
	methods: {
		...
		show() {
			...
			this.editData = this.$http.xget("/supplier/ecode", { id: id })
			this.editData.id = id
