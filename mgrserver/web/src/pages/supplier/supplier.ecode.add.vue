    ...
    <el-form :model="addData" :inline="true" :rules="rules" ref="addForm" label-width="110px">
      <el-form-item label="编号" prop="id">
			...
			<el-form-item label="分类:" prop="category">
				<el-select style="width: 100%;"	v-model="addData.category"	clearable filterable class="input-cos" placeholder="---请选择---">
			...
			<el-form-item label="处理码:" prop="deal_code">
				<el-select style="width: 100%;"	v-model="addData.deal_code"	clearable filterable class="input-cos" placeholder="---请选择---">
