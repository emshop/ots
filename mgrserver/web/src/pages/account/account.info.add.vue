    ...
    <el-form :model="addData" :inline="true" :rules="rules" ref="addForm" label-width="110px">
      <el-form-item label="帐户名称" prop="account_name">
			...
			<el-form-item label="系统标识:" prop="ident">
				<el-select style="width: 100%;"	v-model="addData.ident"	clearable filterable class="input-cos" placeholder="---请选择---">
			...
			<el-form-item label="用户分组:" prop="groups">
				<el-select style="width: 100%;"	v-model="addData.groups"	clearable filterable class="input-cos" placeholder="---请选择---">
			...
			<el-form-item label="商户信息:" prop="eid">
				<el-select style="width: 100%;"	v-model="addData.eid"	clearable filterable class="input-cos" placeholder="---请选择---">
