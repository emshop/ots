  ...
  <el-dialog title="添加账户信息" width="65%"  :visible.sync="dialogAddVisible">
    <el-form :model="addData" :inline="true" :rules="rules" ref="addForm" label-width="110px">
      <el-form-item label="帐户名称" prop="account_name">
				<el-input maxlength="32" clearable v-model="addData.account_name" placeholder="请输入帐户名称">
				</el-input>
      </el-form-item>
      
      
			<el-form-item label="系统标识:" prop="ident">
				<el-select  placeholder="---请选择---" clearable v-model="addData.ident" style="width: 100%;">
      ...
      <el-form-item label="信用余额" prop="credit">
				<el-input maxlength="0" clearable v-model="addData.credit" placeholder="请输入信用余额">
				</el-input>
      </el-form-item>
