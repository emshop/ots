	...
	<el-dialog title="编辑商户货架" width="65%" @closed="closed" :visible.sync="dialogFormVisible">
      ...
      <el-form-item label="支付超时时长" prop="payment_timeout">
			...
			<el-form-item label="开票方式:" prop="invoice_type">
				<el-select style="width: 100%;"	v-model="editData.invoice_type"	clearable filterable class="input-cos" placeholder="---请选择---">
			...
			<el-form-item label="允许退款:" prop="can_refund">
				<el-select style="width: 100%;"	v-model="editData.can_refund"	clearable filterable class="input-cos" placeholder="---请选择---">
      ...
      <el-form-item label="单次购买数量" prop="limit_count">
			...
			<el-form-item label="允许拆单:" prop="can_split_order">
				<el-select style="width: 100%;"	v-model="editData.can_split_order"	clearable filterable class="input-cos" placeholder="---请选择---">
...
export default {
	...
	methods: {
		...
		show() {
			this.editData = this.$http.xget("/merchant/shelf", { mer_shelf_id: this.editData.mer_shelf_id })
