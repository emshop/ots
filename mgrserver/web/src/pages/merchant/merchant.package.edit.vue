<template>
	<el-dialog title="编辑组合商品" width="65%" @closed="closed" :visible.sync="dialogFormVisible">
...
export default {
	...
	methods: {
		...
		show() {
			...
			this.editData = this.$http.xget("/merchant/package", { pg_id: pg_id })
			this.editData.pg_id = pg_id
			this.dialogFormVisible = true;
		},
		edit() {
			this.$http.put("/merchant/package", this.editData, {}, true, true)
			.then(res => {			
