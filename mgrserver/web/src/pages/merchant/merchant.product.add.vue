  ...
  <el-dialog title="添加商户商品" width="65%"  :visible.sync="dialogAddVisible">
    <el-form :model="addData" :inline="true" :rules="rules" ref="addForm" label-width="110px">
			...
			<el-form-item label="货架名称:" prop="mer_shelf_id">
				<el-select  placeholder="---请选择---" clearable v-model="addData.mer_shelf_id" style="width: 100%;">
			...
			<el-form-item label="商户名称:" prop="mer_no">
				<el-select  placeholder="---请选择---" clearable v-model="addData.mer_no" style="width: 100%;">
      ...
      <el-form-item label="商户商品编号" prop="mer_product_no">
				<el-input maxlength="32" clearable v-model="addData.mer_product_no" placeholder="请输入商户商品编号">
				</el-input>
      </el-form-item>
      
      <el-form-item label="销售折扣" prop="discount">
				<el-input  clearable v-model="addData.discount" placeholder="请输入销售折扣">
				</el-input>
      </el-form-item>
