...
export default {
	...
	methods: {
		...
		show() {
			var mer_product_id = this.editData.mer_product_id
			this.editData = this.$http.xget("/merchant/product", { mer_product_id: mer_product_id })
			this.editData.mer_product_id = mer_product_id
