    ...
    <el-form :model="addData" :inline="true" :rules="rules" ref="addForm" label-width="110px">
      <el-form-item label="货架名称" prop="mer_shelf_name">
			...
			<el-form-item label="商户名称:" prop="mer_no">
				<el-select style="width: 100%;"	v-model="addData.mer_no"	clearable filterable class="input-cos" placeholder="---请选择---">
      ...
      <el-form-item label="支付超时时长" prop="payment_timeout">
			...
			<el-form-item label="开票方式:" prop="invoice_type">
				<el-select style="width: 100%;"	v-model="addData.invoice_type"	clearable filterable class="input-cos" placeholder="---请选择---">
			...
			<el-form-item label="允许退款:" prop="can_refund">
				<el-select style="width: 100%;"	v-model="addData.can_refund"	clearable filterable class="input-cos" placeholder="---请选择---">
      ...
      <el-form-item label="单次购买数量" prop="limit_count">
			...
			<el-form-item label="允许拆单:" prop="can_split_order">
				<el-select style="width: 100%;"	v-model="addData.can_split_order"	clearable filterable class="input-cos" placeholder="---请选择---">
