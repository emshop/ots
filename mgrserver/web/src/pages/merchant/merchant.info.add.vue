  ...
  <el-dialog title="添加商户信息" width="65%"  :visible.sync="dialogAddVisible">
    <el-form :model="addData" :inline="true" :rules="rules" ref="addForm" label-width="110px">
      <el-form-item label="编号" prop="mer_no">
				<el-input clearable v-model="addData.mer_no" placeholder="请输入编号">
				</el-input>
      </el-form-item>
      
      <el-form-item label="名称" prop="mer_name">
				<el-input clearable v-model="addData.mer_name" placeholder="请输入名称">
				</el-input>
      </el-form-item>
      
      <el-form-item label="公司" prop="mer_crop">
				<el-input clearable v-model="addData.mer_crop" placeholder="请输入公司">
				</el-input>
      </el-form-item>
      
      <el-form-item label="类型" prop="mer_type">
				<el-input clearable v-model="addData.mer_type" placeholder="请输入类型">
				</el-input>
      </el-form-item>
      
      
			<el-form-item label="商务人员:" prop="bd_uid">
				<el-select  placeholder="---请选择---" clearable v-model="addData.bd_uid" style="width: 100%;">
